...
int main(int argc, char* argv[])
{
   ...
   jwsmtp::mailer m("l_huiwu@126.com", "l_huiwu@126.com", "subject line",
                    "This is the plain text part of the message", "smtp.126.com",
   ...
   //m.password("secret");
   m.username("l_huiwu@126.com");
   m.password("zxc639784368");
